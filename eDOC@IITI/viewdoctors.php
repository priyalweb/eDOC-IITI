    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page"><span
                    style="color: rgb(0, 0, 0);font-size: 30px;font-family: Bahnschrift SemiBold;padding: 10px;">Doctor's List
                    </span></li>
        </ol>
    </nav>
      ...
      if($total!=0)
      {
          while($result=mysqli_fetch_assoc($data))
          {
            ...
            if($result['gender']==1)
              ...
              <td><a href='updatedoctor.php?did=$result[doctor_id]&cid=$cid&pp=$dg&ln=$result[last_name]&fn=$result[first_name]&eml=$result[email]&cn=$result[contact]&img=$result[image]&gen=$result[gender]&dse=$result[description]'>Update</a>
               <br>
