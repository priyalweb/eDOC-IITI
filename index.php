...
<body>
    ...
    <div class="container" id="maincontent">
        ...
        <div class="container" id="buttons">
            <button onclick="goto_patient_login_page()" style="border: solid 3px white ;" type="button" id="button1" class="btn btn-danger btn-lg">Login As
                Patient</button>
            <button onclick="goto_dr_login_page()" style="border: solid 3px white ;" type="button" id="button2" class="btn btn-success btn-lg">Login As
                Doctor</button>
            <button onclick="goto_admin_login_page()" style="border: solid 3px white ;" type="button" id="button3" class="btn btn-warning btn-lg">Login As
                Admin</button>
        </div>
    </div>
