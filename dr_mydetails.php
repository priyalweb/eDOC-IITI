...
if (isset($_GET['go_back_btn_dr_details'])) {
    header("location: http://localhost/eDOC@IITI/dashboard.php");
}

$sqldetails = "SELECT * FROM `d_profile` WHERE `doctor_id` = $_SESSION[doctor_id]";
...
<head>
    ...
    <title>Doctor_Details_Page</title>
    <meta charset="utf-8">
...
<header>
    ...
    <div class="container" id="dr_appointment_maincontainer">
        <h1 style="text-align:left; color:mediumvioletred  ;">HOLA <?php echo ucwords($_SESSION['d_name']) ?></h1>
        <h1 style="text-align:left; color:navy ;">THIS IS MY REGISTERED DETAILS !</h1>
        <br>
        ...
        <table style="width:90%" class="table table-bordered table-dark">
            ...
            if ($result->num_rows > 0) {
                while ($rowmydetails = $result->fetch_assoc()) {


            ?>
            <?php  $_SESSION['category_id'] = $rowmydetails['category_id']; ?>
                    <tr>
                        <th>d_profile_id</th>
                        <td><?php echo $rowmydetails['d_profile_id']; ?></td>
                    </tr>
                    <tr>
                        <th>doctor_id</th>
                        <td><?php echo $rowmydetails['doctor_id']; ?></td>
                    </tr>
                    <tr>
                    <?php $_SESSION['category_id'] = $rowmydetails['category_id'];  ?>
                        <th>category_id</th>
                        <td><?php echo $rowmydetails['category_id']; ?></td>
                    </tr>
                    <tr>
                        <th>first_name</th>
                        <td><?php echo $rowmydetails['first_name']; ?></td>
                    </tr>
                    <th>last_name</th>
                    <td><?php echo $rowmydetails['last_name']; ?></td>
                    </tr>

                    <tr>
                        <th>email </th>
                        <td><?php echo $rowmydetails['email']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>gender</th>
                        <td><?php echo $rowmydetails['gender']; ?></td>
                    </tr>
                    <tr>
                        <th>description</th>
                        <td><?php echo $rowmydetails['description']; ?></td>
                    </tr>
                <?php
                }
            } else {
    ...
    <a href="http://localhost/eDOC@IITI/dashboard.php"> <button type="button" name="go_back_btn_dr_details" id="go_back_btn_dr_details" class="btn btn-danger">DONE / GO BACK</button></a>
