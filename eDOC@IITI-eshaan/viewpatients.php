      ...
      if($total!=0)
      {
          while($result=mysqli_fetch_assoc($data))
          {
            ...
            $dg = $row889[4] ?? false;
              ...
              <td><a href='updatepatient.php?did=$result[patient_id]&cid=$cid&pp=$dg&ln=$result[last_name]&fn=$result[first_name]&eml=$result[email]&cn=$result[contact_number]&img=$result[roll_number]&gen=$result[gender]&dse=$result[room_number]'>Update</a>
               <br>
